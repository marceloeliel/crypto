      ...
      <div className="px-4 py-2">
        ...
        <div className="flex justify-stretch gap-3 py-6">
          ...
          >
            <div className="flex size-12 items-center justify-center rounded-full bg-zinc-800 group-active:scale-95 transition-all outline outline-1 outline-white/5">
              <span className="material-symbols-outlined text-white text-2xl">import_export</span>
            </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            {(() => {
              const stableCoins = coins.filter(c => c.userBalance > 0 && c.symbol !== 'USDT' && c.symbol === 'USDC'); // Effectively empty for now unless USDC is added
